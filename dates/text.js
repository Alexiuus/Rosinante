...
Sky\`. \n\n :two: If you use **/rs** \`<season> <traveler>\` (<season> is the season you \
want to watch) Rosinante and <traveler> is the traveler you want to watch Rosinante will respond \
